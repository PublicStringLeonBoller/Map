...
function getNicoMark() {
    $.ajax({
        type: "GET",
        url: "https://nhorenstein.com/Coordenada/GetConPunto",
        success: function (result) {
            if (result.ok) {
                agregarMarcador(result.return.latitud, result.return.longitud);
            } else {
                Swal.fire(
                    "Algo fallo",
                    "Redireccionamos al sitio por default?",
                    "question"
                );
                agregarMarcador(-31.44236866651806, -64.19403308994077);
            }
        },
...
function agregarMarcador(latitud, longitud) {
    ...
    var platform = new H.service.Platform({
        apikey: "rjPE9_fQcN20nb9btDuzT4yz7MCE_9CCcCQIbu4LpX4",
    });
